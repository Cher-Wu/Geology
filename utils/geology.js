/*!
	\file geology.js
	\author Gabriel Godefroy <gabriel.godefroy@univ-lorraine.fr>
*/
...
/*! \brief Array of script to include. 
	Should be included directly when build from the c++ files */
var required_script = [];
required_script.push("../ext_lib.js/three.js/build/three.min.js");
required_script.push("../ext_lib.js/three.js/examples/js/controls/TrackballControls.js");
required_script.push("../ext_lib.js/three.js/examples/js/math/Lut.js");
required_script.push("../ext_lib.js/jscolor/jscolor.min.js");

/*! \fn void include_script(fileName)
	\param fileName Name of the javascript file to include 
*/
var include_script = function(fileName){
...
/*! \brief Include all scripts */
var loadScripts =function(){
	for (ind in required_script){
		include_script(required_script[ind]);
	}
}
...
ObjectViewer.prototype.append_surface = function(numbers, color, name)
{
    ...
    var geometry = this.create_surface_geometry(numbers) ;
   	...
   	this.append_mesh(surface,name,numbers,"Surface",color);
}
...
ObjectViewer.prototype.append_points = function(numbers, color, name)
{
	...
	this.append_mesh(points,name,numbers, "Points",color)
}
...
ObjectViewer.prototype.append_lines = function(numbers, color, name)
{
	...
	this.append_mesh(line,name,numbers,"Line",color);		
}
